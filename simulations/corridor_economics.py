...
-----------------------
The original framing bundled two different physics questions into one
...
Real value found in literature research: Martian dust vertical scale height
...
def main() -> None:
    ...
    print(f"""
[SYNTHESIS — the original proposal, disentangled]
...
2. "Shorter hop distance, more economical" -- checked directly above,
   ...
   - On pure hub CAPITAL cost, shorter hops are WORSE, not better: total
     ...
     "unviable physics" that needs flagging plainly, even though it
     complicates the original framing.
