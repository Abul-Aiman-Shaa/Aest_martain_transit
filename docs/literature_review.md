...
**Prompted by:** the user's proposal to close the PV-efficiency gap
...
**What this resolves:** the user's own proposal worried that a
...
`simulations/corridor_economics.py` (Module 5, new this session) use
